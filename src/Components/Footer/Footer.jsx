    ...
    return (
        <div className='footer  sm:footer-horizontal bg-neutral  text-neutral-content p-10'>
            ...
            <aside>
                ...
                <p>
                &copy; all right reserved to Ayesha Siddiqua Mukta 2025.
                </p>
            </aside>
            <nav>
                <h6 className="footer-title">Social</h6>
                <div className="grid grid-flow-col text-3xl gap-4">
                    <a target='#blank' href='https://github.com/ayeshamukta' >
                    <FaGithub />
                    </a>
                    <a target='blank' href='https://www.linkedin.com/in/ayesha-siddiqua-mukta-8ab26a2ba/'>
                    <FaLinkedin />
                    </a>
